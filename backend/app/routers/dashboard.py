...
from ..schemas import (
    HealthResponse, PotlinesResponse, PotsResponse,
    LayerLatestResponse, LayerRangeResponse,
    Log1hResponse, DailyLatestResponse,
)
...
async def get_recommendations(
    ...
    recs = RecommendationEngine.generate_recommendations(current_row, history_rows=list(reversed(rows)))
