...
const getStatusIcon = (status) => {
    ...
    if (s === 'optimal' || s === 'good') return <CheckCircle size={14} color="#22c55e" />;
    ...
    return (
        <div className="pot-section">
            <div className="pot-grid">
                {pots.map((pot, index) => {
                    const potNumber = pot.id || (pot.name ? pot.name.split(' ')[1] : index + 1);
                    const potStatus = pot.status || (pot.value >= 90 ? 'optimal' : 'warning');
                    ...
                    return (
                        ...
                        >
                            ...
                            <div className="pot-value-container" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '2px' }}>
