...
import { ArrowLeft, Bell, Check, Trash2, AlertTriangle, Info, CheckCircle, XCircle } from 'lucide-react';
    ...
    return (
        <div className={`dashboard-container ${isDarkMode ? 'dark-mode' : ''}`}>
            ...
            {loading ? (
                ...
                <div className="notification-list" style={{ maxWidth: '100%', margin: '0' }}>
