				...
				<form onSubmit={handleSubmit}>
					...
					<div className="form-group">
						...
						<div className="strength-meter">
							{[0, 1, 2, 3].map((i) => (
								<div
									key={i}
									className={`strength-bar ${getStrengthBarClass(i)}`}
								/>
							))}
						</div>
						{errors.password && (
							<span className="validation-text">{errors.password}</span>
						)}
					</div>
					...
					<div className="form-group">
						...
						{errors.confirmPassword && (
							<span className="validation-text">{errors.confirmPassword}</span>
						)}
					</div>
					...
					{errors.agreeTerms && (
						<span className="validation-text" style={{ marginBottom: "1rem" }}>
							{errors.agreeTerms}
						</span>
					)}
