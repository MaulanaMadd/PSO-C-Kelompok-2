...
import { User, Mail, Phone, LogOut, ChevronLeft, Camera, Edit2, Save, X, Shield } from 'lucide-react';
    ...
    return (
        <div className={`dashboard-container ${isDarkMode ? 'dark-mode' : ''}`}>
            ...
            <div className="profile-content-wrapper">
                {/* Navigation & Actions */}
                <div className="detail-navigation-bar" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                        ...
                        {isEditing ? (
                            <>
                                <button
                                    ...
                                    style={{ background: '#fef2f2', color: '#ef4444', borderColor: '#fca5a5' }}
                                >
                                    <X size={16} /> Cancel
                                </button>
                                <button
                ...
                <div className="profile-grid">
                    ...
                    <div className="profile-sidebar-card">
                        ...
                        <div className="profile-identity">
                            <h2 className="profile-name">{displayUser.full_name || 'No Name'}</h2>
                        ...
                        <button className="logout-btn-full" onClick={() => authService.logout()}>
